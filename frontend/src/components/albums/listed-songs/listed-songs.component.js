            ...
            <br/>
              {
                this.state.songs.map((song, index) => (
                  ...
                  <div className="widget-latest-post">
                    <a onClick={() => this.props.playSong(song)} className="fea-image pointer" id={song.id} onMouseLeave={() => this.hideListedSong(song.id)} onMouseOver={() => this.handleListedSong(song.id)}>
